...
class UIComponantManager: NSObject {
    
    //MARK:- Create Instance of Class
//    class var sharedInstance: UIComponantManager {
//
//        struct Static {
//            static let instance = UIComponantManager()
//        }
...
//    }
    ...
    func setTextFieldCursorColor(color : String)
    {
        UITextField.appearance().tintColor = hexStringToUIColor(hex: color)
    }
